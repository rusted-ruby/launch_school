...
/*
Let's make some improvements to the school program
  make the student list private (may have already done this)
  make the constraint for allowed years private (may have already done this)
  make getCourse accessable in the addGrade method. only courseReport has this now.

  hm, LS did this by making the createSchool function an IIFE... I don't really understand
  why you'd want to do that unless you explicitly only want to create one school object. 
*/
