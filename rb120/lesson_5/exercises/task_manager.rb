class TaskManager
  ...
  def display(tasks)
    puts "--------"
    # note - this "tasks" here is a local variable named tasks that is passed into the method
    # NOT the getter method... although they do both return the same thing. 
    tasks.each do |task|
      puts task
    end
    puts "--------"
...
valentinas_tasks.display_high_priority_tasks # => this is the error origin